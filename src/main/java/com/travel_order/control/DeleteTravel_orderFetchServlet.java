...
@WebServlet("/deletetravel_orderfetchservlet")
public class DeleteTravel_orderFetchServlet extends HttpServlet{
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        int rr = jsonObject.get("id").getAsInt();//main.js第89行
		Travel_orderDAO travel_orderDAO = new Travel_orderDAO();
		travel_orderDAO.delete(rr);
