...
import com.ships_schedule.control.SqlDateAdapter;
import com.travel_order.model.Travel_orderDAO;
import com.travel_order.model.Travel_orderVO;

@WebServlet("/updatetravel_orderfetchservlet")
public class UpdateTravel_orderFetchServlet extends HttpServlet{
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        travel_orderDAO.update(travel_order); // 调用 update 方法，传递 Route 对象
